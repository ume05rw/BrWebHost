...
namespace ScriptAgent.Migrations
{
    ...
    [Migration("20190122041111_CreateDb")]
            ...
            modelBuilder.Entity("BrWebHost.Models.Entities.Control", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 51, Code = "notepad.exe", Color = "#F92068", ControlSetId = 10, IconUrl = "", IsAssignToggleOff = false, IsAssignToggleOn = false, Name = "NotePad", PositionLeft = 95, PositionTop = 5 }
                    );
                });
            ...
            modelBuilder.Entity("BrWebHost.Models.Entities.ControlSet", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 10, Color = "#81c03b", IconUrl = "images/icons/operation/large/script.png", IsMainPanelReady = true, IsTemplate = false, IsTogglable = true, Name = "On your PC", OperationType = 4, Order = 99999, ToggleState = false }
                    );
                });
