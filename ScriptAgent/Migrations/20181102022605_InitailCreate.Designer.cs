...
namespace ScriptAgent.Migrations
{
    ...
    [Migration("20181102022605_InitailCreate")]
            ...
            modelBuilder.Entity("BrWebHost.Models.Entities.ControlSet", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Color = "#fcc91f", IconUrl = "images/icons/controlset/tv.png", IsMainPanelReady = true, IsTemplate = true, IsTogglable = true, Name = "TV", OperationType = 1, Order = 99999, ToggleState = false },
                        new { Id = 2, Color = "#F92068", IconUrl = "images/icons/controlset/av.png", IsMainPanelReady = true, IsTemplate = true, IsTogglable = true, Name = "AV", OperationType = 1, Order = 99999, ToggleState = false },
                        new { Id = 3, Color = "#ccdc4b", IconUrl = "images/icons/controlset/light.png", IsMainPanelReady = true, IsTemplate = true, IsTogglable = true, Name = "Light", OperationType = 1, Order = 99999, ToggleState = false },
                        new { Id = 4, Color = "#6545C6", IconUrl = "images/icons/controlset/aircompressor.png", IsMainPanelReady = true, IsTemplate = true, IsTogglable = true, Name = "Air Complessor", OperationType = 1, Order = 99999, ToggleState = false },
                        new { Id = 5, Color = "#84bde8", IconUrl = "images/icons/controlset/a1.png", IsMainPanelReady = true, IsTemplate = true, IsTogglable = false, Name = "A1 Sensor", OperationType = 2, Order = 99999, ToggleState = false },
                        new { Id = 6, Color = "#84bde8", IconUrl = "images/icons/controlset/sp2.png", IsMainPanelReady = true, IsTemplate = true, IsTogglable = true, Name = "Sp2 Switch", OperationType = 2, Order = 99999, ToggleState = false },
                        new { Id = 7, Color = "#84bde8", IconUrl = "images/icons/controlset/sp2.png", IsMainPanelReady = true, IsTemplate = true, IsTogglable = true, Name = "Sp1 Switch", OperationType = 2, Order = 99999, ToggleState = false },
                        new { Id = 8, Color = "#84bde8", IconUrl = "images/icons/controlset/sp2.png", IsMainPanelReady = true, IsTemplate = true, IsTogglable = true, Name = "Single Control", OperationType = 2, Order = 99999, ToggleState = false },
                        new { Id = 9, Color = "#84bde8", IconUrl = "images/icons/controlset/sp2.png", IsMainPanelReady = true, IsTemplate = true, IsTogglable = true, Name = "No Control", OperationType = 2, Order = 99999, ToggleState = false }
                    );
                });
