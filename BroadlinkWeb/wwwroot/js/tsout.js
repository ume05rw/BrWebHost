    ...
    (function (Controllers) {
        ...
        var ControlPropertyController = /** @class */ (function (_super) {
            ...
            function ControlPropertyController() {
                ...
                _this._page.BtnSend.AddEventListener(Events.ButtonViewEvents.SingleClick, function (je, eo) { return __awaiter(_this, void 0, void 0, function () {
                    var code, ctr;
                    return __generator(this, function (_a) {
                        je.stopPropagation();
                        if (!this._control)
            ...
            ControlSetController.prototype.SetEntity = function (entity) {
                ...
                if (this._controlSet) {
                    ...
                    _.each(this._controlSet.Controls, function (control) {
                        ...
                        btn.AddEventListener(ControlButtonViewEvents.EditOrdered, function (e, p) { return __awaiter(_this, void 0, void 0, function () {
