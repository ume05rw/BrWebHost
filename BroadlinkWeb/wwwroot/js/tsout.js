...
(function (App) {
    ...
    (function (Views_2) {
        ...
        })(Controls = Views_2.Controls || (Views_2.Controls = {}));
    })(Views = App.Views || (App.Views = {}));
})(App || (App = {}));
/// <reference path="../../../../lib/jquery/index.d.ts" />
/// <reference path="../../../../lib/underscore/index.d.ts" />
        ...
        (function (Pages) {
            ...
            var MainPageView = /** @class */ (function (_super) {
                ...
                function MainPageView() {
                    ...
                    _this.HeaderBar.Text = Lang.Title;
                    ...
                    _this.ScenePanel.SetAnchor(null, 10, 10, 16);
                    ...
                    _this.ControlSetPanel.SetAnchor(70, 10, 10, 226);
        ...
        var ControlSetController = /** @class */ (function (_super) {
            ...
            function ControlSetController(controllerId) {
                ...
                _this._page.HeaderBar.LeftButton.AddEventListener(ButtonEvents.SingleClick, function () { return __awaiter(_this, void 0, void 0, function () {
                    var errors, err, ctr_1, ctr_2, exec, err, ctr_3, ctr_4, controlSet, ctr, views, isSave, res;
                    var _this = this;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                if (this._operationType !== 2 /* Edit */
                                    || !this._controlSet)
                                    return [2 /*return*/];
                                return [4 /*yield*/, Stores.Validations.Validate(this._controlSet)];
                            case 1:
                                errors = _a.sent();
                                ...
                                if (err.Entity instanceof Entities.ControlSet) {
                                    ctr_1 = this.Manager.Get('ControlHeaderProperty');
                                    ctr_1.SetEntity(this._controlSet);
                                    ctr_1.ShowModal();
                                }
                                else if (err.Entity instanceof Entities.Control) {
                                    ctr_2 = this.Manager.Get('ControlProperty');
                                    ctr_2.SetEntity(err.Entity, this._controlSet);
                                    ctr_2.ShowModal();
                                }
                                return [2 /*return*/];
                            ...
                            case 3:
                                ...
                                if (exec === false) {
                                    err = errors[0];
                                    if (err.Entity instanceof Entities.ControlSet) {
                                        ctr_3 = this.Manager.Get('ControlHeaderProperty');
                                        ctr_3.SetEntity(this._controlSet);
                                        ctr_3.ShowModal();
                                    }
                                    else if (err.Entity instanceof Entities.Control) {
                                        ctr_4 = this.Manager.Get('ControlProperty');
                                        ctr_4.SetEntity(err.Entity, this._controlSet);
                                        ctr_4.ShowModal();
                                    }
                                    return [2 /*return*/];
                                }
                            ...
                            case 4:
                                ...
                                isSave = true;
                                if (!(controlSet.Controls.length <= 0)) return [3 /*break*/, 6];
    ...
    (function (Controllers) {
        ...
        var A1SetController = /** @class */ (function (_super) {
            ...
            function A1SetController() {
                ...
                _this._btnChartChange.Text = Lang.ToDaily;
                ...
                _this._btnChartChange.AddEventListener(Fw.Events.ButtonViewEvents.SingleClick, function () {
                    if (_this._chartType === 1 /* Hourly */) {
                        ...
                        _this._btnChartChange.Text = Lang.ToHourly;
                        _this.SetChart();
                    }
            ...
            A1SetController.prototype.ApplyFromEntity = function () {
                var _this = this;
                if (!this._controlSet)
                    return;
                this._page.HeaderBar.Text = this._controlSet.Name;
            ...
            return A1SetController;
        }(Controllers.ControlSetController));
        Controllers.A1SetController = A1SetController;
    })(Controllers = App.Controllers || (App.Controllers = {}));
})(App || (App = {}));
/// <reference path="../../../../lib/jquery/index.d.ts" />
/// <reference path="../../../../lib/underscore/index.d.ts" />
    ...
    (function (Models) {
        ...
        (function (Stores) {
            ...
            var BrDeviceStore = /** @class */ (function (_super) {
                ...
                BrDeviceStore.prototype.GetFirstRmDevice = function () {
                    var keys = Object.keys(this.List);
                    for (var i = 0; i < keys.length; i++) {
                        var dev = this.List[keys[i]];
    ...
    (function (Controllers) {
        ...
        var MainController = /** @class */ (function (_super) {
            ...
            function MainController() {
                ...
                _this._page.HeaderBar.RightButton.AddEventListener(ButtonEvents.SingleClick, function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ctr = this.Manager.Get('TemplateSelect');
                                return [4 /*yield*/, ctr.Select(this)];
                            case 1:
                                item = _b.sent();
                                _a = item;
                                switch (_a) {
                                    case 2 /* Tv */: return [3 /*break*/, 2];
                                    case 3 /* Av */: return [3 /*break*/, 4];
                                    case 4 /* Light */: return [3 /*break*/, 6];
                                    case 6 /* Free */: return [3 /*break*/, 8];
                                    case 7 /* WoL */: return [3 /*break*/, 10];
                                    case 8 /* Script */: return [3 /*break*/, 12];
                                    case 9 /* RemoteHostScript */: return [3 /*break*/, 14];
                                    case 1 /* Scene */: return [3 /*break*/, 16];
                                    case 10 /* Schedule */: return [3 /*break*/, 17];
                                }
                                return [3 /*break*/, 18];
                            case 2: return [4 /*yield*/, Stores.ControlSets.GetTemplateClone(ControlSetTemplate.Tv)];
                            case 3:
                                ctrSet = _b.sent();
                                rmDev1 = Stores.BrDevices.GetFirstRmDevice();
                                if (rmDev1 !== null)
                                    ctrSet.BrDeviceId = rmDev1.Id;
                                return [3 /*break*/, 19];
                            case 4: return [4 /*yield*/, Stores.ControlSets.GetTemplateClone(ControlSetTemplate.Av)];
                            case 5:
                                ctrSet = _b.sent();
                                rmDev2 = Stores.BrDevices.GetFirstRmDevice();
                                if (rmDev2 !== null)
                                    ctrSet.BrDeviceId = rmDev2.Id;
                                return [3 /*break*/, 19];
                            case 6: return [4 /*yield*/, Stores.ControlSets.GetTemplateClone(ControlSetTemplate.Light)];
                            case 7:
                                ctrSet = _b.sent();
                                rmDev3 = Stores.BrDevices.GetFirstRmDevice();
                                if (rmDev3 !== null)
                                    ctrSet.BrDeviceId = rmDev3.Id;
                                return [3 /*break*/, 19];
                            case 8: return [4 /*yield*/, Stores.ControlSets.GetTemplateClone(ControlSetTemplate.NoControl)];
                            case 9:
                                ctrSet = _b.sent();
                                ctrSet.OperationType = 1 /* RemoteControl */;
                                ctrSet.Name = 'Free Edit';
                                ctrSet.Color = Color.ButtonColors[7];
                                ctrSet.IconUrl = Icon.GetByOperationTemplate(6 /* Free */, true);
                                rmDev4 = Stores.BrDevices.GetFirstRmDevice();
                                if (rmDev4 !== null)
                                    ctrSet.BrDeviceId = rmDev4.Id;
                                return [3 /*break*/, 19];
                            case 10: return [4 /*yield*/, Stores.ControlSets.GetTemplateClone(ControlSetTemplate.SingleControl)];
                            case 11:
                                ctrSet = _b.sent();
                                ctrSet.OperationType = 3 /* WakeOnLan */;
                                ctrSet.Name = 'Wake on LAN';
                                ctrSet.Color = Color.ButtonColors[2];
                                ctrSet.IconUrl = Icon.GetByOperationTemplate(7 /* WoL */, true);
                                ...
                                return [3 /*break*/, 19];
                            case 12: return [4 /*yield*/, Stores.ControlSets.GetTemplateClone(ControlSetTemplate.SingleControl)];
                            case 13:
                                ctrSet = _b.sent();
                                ...
                                ctrSet.Controls[0].IsAssignToggleOff = true;
                                return [3 /*break*/, 19];
                            case 14: return [4 /*yield*/, Stores.ControlSets.GetTemplateClone(ControlSetTemplate.SingleControl)];
                            case 15:
                                ctrSet = _b.sent();
                                ctrSet.OperationType = 5 /* RemoteHostScript */;
                                ctrSet.Name = 'Remote Script';
                                ctrSet.Color = Color.ButtonColors[2];
                                ctrSet.IconUrl = Icon.GetByOperationTemplate(9 /* RemoteHostScript */, true);
                            ...
                            case 16:
                                ...
                                return [2 /*return*/];
                            case 17:
                                ctr2_1 = this.Manager.Get('Schedule');
                                schedule = new Entities.Schedule();
                                ctr2_1.SetEntity(schedule);
                                ctr2_1.SetEditMode();
                                ctr2_1.Show();
                                // ※シーンとスケジュールのみ、対象Entity/起動画面が違う。このセクションでreturnする。
                                return [2 /*return*/];
            ...
            MainController.prototype.RefreshScenesAndSchedules = function () {
                return __awaiter(this, void 0, void 0, function () {
                    var promises, entities, children;
                    var _this = this;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                            ...
                            case 1:
                                _a.sent();
                                entities = [];
                                _.each(Stores.Scenes.List, function (e) { entities.push(e); });
                                _.each(Stores.Schedules.List, function (e) { entities.push(e); });
    ...
    (function (Controllers) {
        ...
        var OperationSelectController = /** @class */ (function (_super) {
            ...
            function OperationSelectController() {
                ...
                _this._page = _this.View;
                _this._page.Label.Text = Lang.SelectRemoteControl;
                _this._controlSets = null;
                _this.IsSceneIncludes = false;
                return _this;
            }
            OperationSelectController.prototype.Select = function (parentController) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        this.InitView();
                        return [2 /*return*/, _super.prototype.Select.call(this, parentController)];
            ...
            OperationSelectController.prototype.RefreshControlSets = function () {
                return __awaiter(this, void 0, void 0, function () {
                    var _a, _b;
        ...
        (function (Controls) {
            ...
            var SceneDetailView = /** @class */ (function (_super) {
                ...
                function SceneDetailView() {
                    ...
                    _this.ControlSetButton.ImageFitPolicy = Property.FitPolicy.Auto;
                    ...
                    _this.ControlButton.ImageFitPolicy = Property.FitPolicy.Auto;
                    ...
                    _this.WaitPreLabel.Text = Lang.Wait;
                    ...
                    _this.WaitPostLabel.Text = Lang.Sec;
                    ...
                    _this.DeleteButton.ImageSrc = 'images/icons/operation/cross.png';
    ...
    (function (Controllers) {
        ...
        var SceneController = /** @class */ (function (_super) {
            ...
            SceneController.prototype.SetEditMode = function () {
                ...
                var ctr = this.Manager.Get('OperationSelect');
                ctr.RefreshControlSets();
                            ...
                            case 5:
                                if (this._operationType === 1 /* Exec */) {
                                    _.delay(function () {
                                        ...
                                        // トグル状態の変更を適用する。
                                        var ctr = _this.Manager.Get('Main');
                                        ctr.RefreshControlSets();
                                    }, 3000);
                                }
                                return [3 /*break*/, 7];
    ...
    (function (Controllers) {
        ...
        var ScheduleController = /** @class */ (function (_super) {
            ...
            ScheduleController.prototype.SetEditMode = function () {
                ...
                this._page.DeleteButton.Show(0);
                _.each(this._page.InputPanel.Children, function (view) {
                    if (view instanceof Fw.Views.InputViewBase) {
...
(function (App) {
    ...
    (function (Controllers) {
        ...
        var Icon = App.Items.Icon;
        var Lang = App.Items.Lang.Lang;
        var TemplateSelectController = /** @class */ (function (_super) {
            __extends(TemplateSelectController, _super);
            function TemplateSelectController() {
                var _this = _super.call(this, 'TemplateSelect') || this;
                _this.SetClassName('TemplateSelectController');
                _this._page = _this.View;
                _this.InitView();
                return _this;
            }
            TemplateSelectController.prototype.InitView = function () {
                var _this = this;
                this._page.Label.Text = Lang.SelectNewOperation;
                // TV
                var btn2 = this.GetNewButton();
                btn2.Label.Text = Lang.Tv;
                btn2.Button.ImageSrc = Icon.GetByOperationTemplate(2 /* Tv */);
                ...
                btn3.Button.ImageSrc = Icon.GetByOperationTemplate(3 /* Av */);
                ...
                btn4.Button.ImageSrc = Icon.GetByOperationTemplate(4 /* Light */);
                ...
                btn5.Button.ImageSrc = Icon.GetByOperationTemplate(6 /* Free */);
                ...
                btn6.Button.ImageSrc = Icon.GetByOperationTemplate(7 /* WoL */);
                ...
                btn7.Button.ImageSrc = Icon.GetByOperationTemplate(8 /* Script */);
                ...
                btn8.Button.ImageSrc = Icon.GetByOperationTemplate(9 /* RemoteHostScript */);
                ...
                btn1.Button.ImageSrc = Icon.GetByOperationTemplate(1 /* Scene */);
                ...
                // スケジュール
                var btn9 = this.GetNewButton();
                btn9.Label.Text = Lang.Timer;
                btn9.Button.ImageSrc = Icon.GetByOperationTemplate(10 /* Schedule */);
                ...
                btn9.Button.AddEventListener(ButtonEvents.SingleClick, function () {
                    _this.Commit(10 /* Schedule */);
                });
                this._page.SelectorPanel.Add(btn9);
            };
            TemplateSelectController.prototype.GetNewButton = function () {
                var button = new LabelAndButtonView();
                button.SetSize(75, 95);
                button.Button.Position.Policy = Property.PositionPolicy.LeftTop;
                button.Button.HasBorder = true;
        ...
        Controllers.TemplateSelectController = TemplateSelectController;
    })(Controllers = App.Controllers || (App.Controllers = {}));
})(App || (App = {}));
/// <reference path="../../../../lib/jquery/index.d.ts" />
/// <reference path="../../../../lib/underscore/index.d.ts" />
        ...
        (function (Pages) {
            ...
            var ScenePageView = /** @class */ (function (_super) {
                ...
                function ScenePageView() {
                    ...
                    background.Src = 'images/Pages/ControlSet/background.jpg';
                    _this.Add(background);
                    _this.HeaderBar.Text = Lang.Scene;
                    _this.HeaderBar.RightButton.Hide(0);
                    _this.Add(_this.HeaderBar);
                    _this.EditButton.SetSize(40, 40);
                    _this.EditButton.BackgroundColor = Color.HeaderButtonBackground;
...
(function (App) {
    ...
    (function (Views_20) {
        ...
        (function (Pages) {
            ...
            var Controls = App.Views.Controls;
            var Color = App.Items.Color;
            var SelectBoxEvents = Fw.Events.SelectBoxInputViewEvents;
            var Lang = App.Items.Lang.Lang;
            var SchedulePageView = /** @class */ (function (_super) {
                ...
                function SchedulePageView() {
                    ...
                    _this.EditButton = new Controls.ButtonView();
                    _this.InputPanel = new Views.StuckerBoxView();
                    _this.LblName = new Views.LabelView();
                    _this.TxtName = new Views.TextBoxInputView();
                    _this.LblColor = new Views.LabelView();
                    _this.BtnColor = new Controls.ItemSelectButtonView();
                    ...
                    _this.LblTimeSeparator = new Views.LabelView();
                    _this.LblStartTime = new Views.LabelView();
                    ...
                    _this.InputPanel.IsChildRelocatable = false;
                    _this.Add(_this.InputPanel);
                    _this.LblName.Text = Lang.Name;
                    _this.LblName.TextAlign = Property.TextAlign.Left;
                    _this.LblName.AutoSize = true;
                    _this.LblName.SetAnchor(null, 5, null, null);
                    _this.LblName.Size.Height = 21;
                    _this.InputPanel.Add(_this.LblName);
                    _this.TxtName.SetAnchor(null, 5, 15, null);
                    _this.TxtName.Size.Height = 30;
                    _this.InputPanel.Add(_this.TxtName);
                    _this.LblColor.Text = Lang.Color;
                    _this.LblColor.TextAlign = Property.TextAlign.Left;
                    _this.LblColor.AutoSize = true;
                    _this.LblColor.SetAnchor(null, 5, null, null);
                    _this.LblColor.Size.Height = 21;
                    _this.InputPanel.Add(_this.LblColor);
                    _this.InputPanel.AddSpacer();
                    _this.InputPanel.Add(_this.BtnColor);
                    _this.InputPanel.AddSpacer();
                    ...
                    _this.ChkEnabled.Text = Lang.Enable;
                    ...
                    _this.SboHour.AddEventListener(SelectBoxEvents.Changed, _this.OnStartTimeChanged, _this);
                    _this.InputPanel.Add(_this.SboHour);
                    _this.LblTimeSeparator.Text = ':';
                    _this.LblTimeSeparator.TextAlign = Property.TextAlign.Center;
                    _this.LblTimeSeparator.SetSize(10, 30);
                    _this.LblTimeSeparator.AutoSize = false;
                    _this.InputPanel.Add(_this.LblTimeSeparator);
                    _this.SboMinute.SetSize(80, 30);
                    for (var i = 0; i < 6; i++) {
                        _this.SboMinute.AddItem(("00" + (i * 10)).slice(-2), (i * 10).toString());
                    }
                    _this.SboMinute.AddEventListener(SelectBoxEvents.Changed, _this.OnStartTimeChanged, _this);
                    _this.InputPanel.Add(_this.SboMinute);
                    _this.LblStartTime = new Views.LabelView();
                    _this.LblStartTime.Text = '00:00';
                    _this.LblStartTime.TextAlign = Property.TextAlign.Left;
                    _this.LblStartTime.AutoSize = true;
                    _this.LblStartTime.SetAnchor(null, 20, null, null);
                    _this.LblStartTime.Size.Height = 21;
                    _this.InputPanel.Add(_this.LblStartTime);
                    _this.InputPanel.AddSpacer();
                    ...
                    _this.ChkWeekdaySunday.Text = Lang.Sunday;
                    ...
                    _this.ChkWeekdayMonday.Text = Lang.Monday;
                    ...
                    _this.ChkWeekdayTuesday.Text = Lang.Tuesday;
                    ...
                    _this.ChkWeekdayWednesday.Text = Lang.Wednesday;
                    ...
                    _this.ChkWeekdayThursday.Text = Lang.Thursday;
                    ...
                    _this.ChkWeekdayFriday.Text = Lang.Friday;
                    ...
                    _this.ChkWeekdaySaturday.Text = Lang.Saturday;
                ...
                SchedulePageView.prototype.OnStartTimeChanged = function () {
